...
module.exports = {
  ...
  STRIPE_CLIENT_TOKEN: process.env.TEST_STRIPE_CLIENT_TOKEN,
  STRIPE_SECRET_TOKEN: process.env.TEST_STRIPE_SECRET_TOKEN,
  STRIPE_WEBHOOK_SECRET_TOKEN: process.env.TEST_STRIPE_WEBHOOK_SECRET_TOKEN
};
