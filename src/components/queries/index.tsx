...
export type AddShortListItemMutation = { __typename?: "Mutation" } & {
  addShortListItem: Maybe<
    Array<
      Maybe<
        | ({ __typename?: "Hymn" } & Pick<
            Hymn,
            "_id" | "_type" | "title" | "hymnNumber"
          >)
        | ({ __typename?: "Prayer" } & Pick<Prayer, "_id" | "_type" | "title">)
        | ({ __typename?: "Liturgy" } & Pick<
            Liturgy,
            "_id" | "_type" | "title"
          >)
        | ({ __typename?: "Scripture" } & Pick<
            Scripture,
            "_id" | "_type" | "title"
          >)
      >
  ...
  search: Maybe<
    Array<
      Maybe<
        | ({ __typename?: "Hymn" } & Pick<
            Hymn,
            "_id" | "_type" | "title" | "content" | "hymnNumber"
          > & {
              keywords: Maybe<
                Array<
                  Maybe<
                    { __typename?: "Keyword" } & Pick<Keyword, "_id" | "name">
                  >
                >
              >;
            })
        | ({ __typename?: "Prayer" } & Pick<
            Prayer,
        ...
        | ({ __typename?: "Scripture" } & Pick<Scripture, "_id" | "_type">)
      >
    >
  >;
};
...
export type ChangePasswordMutation = { __typename?: "Mutation" } & {
  changePassword: Maybe<{ __typename?: "User" } & Pick<User, "_updatedAt">>;
};
...
export type CreateUserMutation = { __typename?: "Mutation" } & {
  createUser: Maybe<
    { __typename?: "User" } & Pick<
      User,
      "_id" | "hasPaidAccount" | "hasFreeAccount" | "picture"
    > & { name: Maybe<{ __typename?: "Name" } & Pick<Name, "first" | "last">> }
  >;
};
...
export type FindKeywordQuery = { __typename?: "Query" } & {
  keywordMany: Maybe<
    Array<Maybe<{ __typename?: "Keyword" } & Pick<Keyword, "_id" | "name">>>
  >;
};
...
export type FindMetreQuery = { __typename?: "Query" } & {
  metreMany: Maybe<
    Array<Maybe<{ __typename?: "Metre" } & Pick<Metre, "_id" | "metre">>>
  >;
};

export type FindOccasionQueryVariables = Record<string, unknown>;

export type FindOccasionQuery = { __typename?: "Query" } & {
  occasionManyGroupById: Maybe<
    Array<
      Maybe<
        { __typename?: "OccasionGroupedById" } & Pick<
          OccasionGroupedById,
          "name"
        > & {
            values: Maybe<
              Array<
                Maybe<
                  { __typename?: "Occasion" } & Pick<Occasion, "_id" | "name">
                >
              >
            >;
          }
...
export type FindOneAuthorQuery = { __typename?: "Query" } & {
  authorById: Maybe<
    { __typename?: "Author" } & Pick<
      Author,
      "_id" | "_type" | "name" | "dates"
    > & {
        hymns: Maybe<
          Array<
            Maybe<
...
export type FindOneHymnQuery = { __typename?: "Query" } & {
  hymnById: Maybe<
    { __typename?: "Hymn" } & Pick<
      Hymn,
      "_id" | "title" | "hymnNumber" | "content" | "scripture"
    > & {
        copyright: Maybe<
          { __typename?: "Copyright" } & Pick<Copyright, "_id" | "name">
        >;
        author: Maybe<
          { __typename?: "Author" } & Pick<Author, "_id" | "dates" | "name">
        >;
        alternateTunes: Maybe<
          Array<
            Maybe<
              { __typename?: "Tune" } & Pick<
                Tune,
                "_id" | "_type" | "title"
              > & {
                  file: Maybe<
        ...
        >;
        tune: Maybe<
          { __typename?: "Tune" } & Pick<Tune, "_id" | "title"> & {
              musicCopyright: Maybe<
                { __typename?: "Copyright" } & Pick<Copyright, "_id" | "name">
              >;
              composer: Maybe<
                { __typename?: "Author" } & Pick<Author, "_id" | "name">
              >;
              metre: Maybe<
                { __typename?: "Metre" } & Pick<Metre, "_id" | "metre">
              >;
              file: Maybe<
                { __typename?: "Asset" } & Pick<
                  Asset,
...
export type FindOneKeywordQuery = { __typename?: "Query" } & {
  keywordById: Maybe<
...
export type FindOneLiturgyQuery = { __typename?: "Query" } & {
  liturgyById: Maybe<
    { __typename?: "Liturgy" } & Pick<Liturgy, "_id" | "title" | "content"> & {
        author: Maybe<
          { __typename?: "Author" } & Pick<Author, "_id" | "dates" | "name">
        >;
        copyright: Maybe<
...
export type FindOnePrayerQuery = { __typename?: "Query" } & {
  prayerById: Maybe<
    { __typename?: "Prayer" } & Pick<Prayer, "_id" | "title" | "content"> & {
        author: Maybe<
          { __typename?: "Author" } & Pick<Author, "_id" | "name" | "dates">
        >;
        copyright: Maybe<
          { __typename?: "Copyright" } & Pick<Copyright, "_id" | "name">
        >;
...
export type FindOneScriptureQuery = { __typename?: "Query" } & {
  scriptureById: Maybe<
    { __typename?: "Scripture" } & Pick<Scripture, "_id" | "title" | "content">
  >;
};
...
export type FindPrayerContentsQuery = { __typename?: "Query" } & {
  prayerPagination: Maybe<
    { __typename?: "PrayerPagination" } & {
      pageInfo: Maybe<
        { __typename?: "PageInfo" } & Pick<
          PageInfo,
          "currentPage" | "itemCount" | "perPage"
        >
      >;
      items: Maybe<
        Array<
...
export type FindTuneQuery = { __typename?: "Query" } & {
  tuneMany: Maybe<
    Array<Maybe<{ __typename?: "Tune" } & Pick<Tune, "_id" | "title">>>
  >;
};
...
export type ChangeFreeAccountMutation = { __typename?: "Mutation" } & {
  changeFreeAccount: Maybe<
    { __typename: "User" } & Pick<User, "hasFreeAccount">
  >;
};

export type HomeQueryVariables = Record<string, unknown>;

export type HomeQuery = { __typename?: "Query" } & {
  main: Maybe<
    { __typename?: "Main" } & Pick<
      Main,
      "heading" | "subheading" | "blurb" | "searchblurb"
    > & {
        menuItems: Maybe<
          Array<
            Maybe<
              { __typename?: "MenuItem" } & Pick<MenuItem, "_key" | "text"> & {
                  childpages: Maybe<
                    Array<
                      Maybe<
                        { __typename?: "ChildPage" } & Pick<
                          ChildPage,
                          "_id" | "alternateText"
                        > & {
                            childPage: Maybe<
                              | ({ __typename?: "PageContent" } & Pick<
                                  PageContent,
                                  "_id" | "_type" | "title"
                                >)
                              | { __typename?: "Hymn" }
...
export type LiturgySearchQuery = { __typename?: "Query" } & {
  liturgySearch: Maybe<
    Array<
      Maybe<
        { __typename?: "Liturgy" } & Pick<
...
export type MeQueryVariables = Record<string, unknown>;

export type MeQuery = { __typename?: "Query" } & {
  me: Maybe<
    { __typename?: "User" } & Pick<
      User,
      "_id" | "email" | "role" | "hasFreeAccount" | "hasPaidAccount" | "picture"
    > & {
        name: Maybe<{ __typename?: "Name" } & Pick<Name, "first" | "last">>;
        shortlist: Maybe<
          Array<
...
export type PageContentQuery = { __typename?: "Query" } & {
  pageContentOne: Maybe<
    { __typename?: "PageContent" } & Pick<
      PageContent,
      "_id" | "title" | "content" | "hasToc" | "slug" | "subtitle"
    >
  >;
};
...
export type PrayerSearchQuery = { __typename?: "Query" } & {
  prayerSearch: Maybe<
    Array<
      Maybe<
        { __typename?: "Prayer" } & Pick<
...
export type RemoveShortListItemMutation = { __typename?: "Mutation" } & {
  removeShortListItem: Maybe<
    Array<
      Maybe<
        | ({ __typename?: "Hymn" } & Pick<
            Hymn,
...
`;
export type AddShortListItemMutationFn = ApolloReactCommon.MutationFunction<
  AddShortListItemMutation,
  AddShortListItemMutationVariables
>;
 ...
 * });
 */
export function useAddShortListItemMutation(
  ...
  return ApolloReactHooks.useMutation<
    AddShortListItemMutation,
    AddShortListItemMutationVariables
  >(AddShortListItemDocument, baseOptions);
}

export type AddShortListItemMutationHookResult = ReturnType<
  typeof useAddShortListItemMutation
>;
export type AddShortListItemMutationResult = ApolloReactCommon.MutationResult<
  AddShortListItemMutation
>;
export type AddShortListItemMutationOptions = ApolloReactCommon.BaseMutationOptions<
  AddShortListItemMutation,
  AddShortListItemMutationVariables
>;
...
export function useAdvancedSearchQuery(
  ...
  return ApolloReactHooks.useQuery<
    AdvancedSearchQuery,
    AdvancedSearchQueryVariables
  >(AdvancedSearchDocument, baseOptions);
}
...
export type AdvancedSearchQueryHookResult = ReturnType<
  typeof useAdvancedSearchQuery
>;
export type AdvancedSearchLazyQueryHookResult = ReturnType<
  typeof useAdvancedSearchLazyQuery
>;
 ...
 * });
 */
export function useFindKeywordQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    FindKeywordQuery,
    FindKeywordQueryVariables
  >
) {
  return ApolloReactHooks.useQuery<FindKeywordQuery, FindKeywordQueryVariables>(
    FindKeywordDocument,
    baseOptions
  );
}

export function useFindKeywordLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    FindKeywordQuery,
    FindKeywordQueryVariables
  >
  ...
  return ApolloReactHooks.useLazyQuery<
    FindKeywordQuery,
    FindKeywordQueryVariables
  >(FindKeywordDocument, baseOptions);
}

export type FindKeywordQueryHookResult = ReturnType<typeof useFindKeywordQuery>;
export type FindKeywordLazyQueryHookResult = ReturnType<
  typeof useFindKeywordLazyQuery
>;
export type FindKeywordQueryResult = ApolloReactCommon.QueryResult<
  FindKeywordQuery,
  FindKeywordQueryVariables
>;
 ...
 * });
 */
export function useFindMetreQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    FindMetreQuery,
    FindMetreQueryVariables
  >
) {
  return ApolloReactHooks.useQuery<FindMetreQuery, FindMetreQueryVariables>(
    FindMetreDocument,
    baseOptions
  );
}

export function useFindMetreLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    FindMetreQuery,
    FindMetreQueryVariables
  >
) {
  return ApolloReactHooks.useLazyQuery<FindMetreQuery, FindMetreQueryVariables>(
    FindMetreDocument,
    baseOptions
  );
}
...
export type FindMetreLazyQueryHookResult = ReturnType<
  typeof useFindMetreLazyQuery
>;
export type FindMetreQueryResult = ApolloReactCommon.QueryResult<
  FindMetreQuery,
  FindMetreQueryVariables
>;
 ...
 * });
 */
export function useFindOccasionQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    FindOccasionQuery,
    FindOccasionQueryVariables
  >
) {
  return ApolloReactHooks.useQuery<
    FindOccasionQuery,
    FindOccasionQueryVariables
  >(FindOccasionDocument, baseOptions);
}

export function useFindOccasionLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    FindOccasionQuery,
    FindOccasionQueryVariables
  >
...
export type FindOccasionQueryHookResult = ReturnType<
  typeof useFindOccasionQuery
>;
export type FindOccasionLazyQueryHookResult = ReturnType<
  typeof useFindOccasionLazyQuery
>;
export type FindOccasionQueryResult = ApolloReactCommon.QueryResult<
  FindOccasionQuery,
  FindOccasionQueryVariables
>;
 ...
 * });
 */
export function useFindOneAuthorQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    FindOneAuthorQuery,
    FindOneAuthorQueryVariables
  >
) {
  return ApolloReactHooks.useQuery<
    FindOneAuthorQuery,
    FindOneAuthorQueryVariables
  >(FindOneAuthorDocument, baseOptions);
}

export function useFindOneAuthorLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    FindOneAuthorQuery,
    FindOneAuthorQueryVariables
  >
...
export type FindOneAuthorQueryHookResult = ReturnType<
  typeof useFindOneAuthorQuery
>;
export type FindOneAuthorLazyQueryHookResult = ReturnType<
  typeof useFindOneAuthorLazyQuery
>;
export type FindOneAuthorQueryResult = ApolloReactCommon.QueryResult<
  FindOneAuthorQuery,
  FindOneAuthorQueryVariables
>;
 ...
 * });
 */
export function useFindOneHymnQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    FindOneHymnQuery,
    FindOneHymnQueryVariables
  >
) {
  return ApolloReactHooks.useQuery<FindOneHymnQuery, FindOneHymnQueryVariables>(
    FindOneHymnDocument,
    baseOptions
  );
}

export function useFindOneHymnLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    FindOneHymnQuery,
    FindOneHymnQueryVariables
  >
  ...
  return ApolloReactHooks.useLazyQuery<
    FindOneHymnQuery,
    FindOneHymnQueryVariables
  >(FindOneHymnDocument, baseOptions);
}

export type FindOneHymnQueryHookResult = ReturnType<typeof useFindOneHymnQuery>;
export type FindOneHymnLazyQueryHookResult = ReturnType<
  typeof useFindOneHymnLazyQuery
>;
export type FindOneHymnQueryResult = ApolloReactCommon.QueryResult<
  FindOneHymnQuery,
  FindOneHymnQueryVariables
>;
 ...
 * });
 */
export function useFindOneKeywordQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    FindOneKeywordQuery,
    FindOneKeywordQueryVariables
  >
) {
  return ApolloReactHooks.useQuery<
    FindOneKeywordQuery,
    FindOneKeywordQueryVariables
  >(FindOneKeywordDocument, baseOptions);
}

export function useFindOneKeywordLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    FindOneKeywordQuery,
    FindOneKeywordQueryVariables
  >
...
export type FindOneKeywordQueryHookResult = ReturnType<
  typeof useFindOneKeywordQuery
>;
export type FindOneKeywordLazyQueryHookResult = ReturnType<
  typeof useFindOneKeywordLazyQuery
>;
export type FindOneKeywordQueryResult = ApolloReactCommon.QueryResult<
  FindOneKeywordQuery,
  FindOneKeywordQueryVariables
>;
 ...
 * });
 */
export function useFindOneLiturgyQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    FindOneLiturgyQuery,
  ...
  return ApolloReactHooks.useQuery<
    FindOneLiturgyQuery,
    FindOneLiturgyQueryVariables
  >(FindOneLiturgyDocument, baseOptions);
}

export function useFindOneLiturgyLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    FindOneLiturgyQuery,
    FindOneLiturgyQueryVariables
  >
...
export type FindOneLiturgyQueryHookResult = ReturnType<
  typeof useFindOneLiturgyQuery
>;
export type FindOneLiturgyLazyQueryHookResult = ReturnType<
  typeof useFindOneLiturgyLazyQuery
>;
export type FindOneLiturgyQueryResult = ApolloReactCommon.QueryResult<
  FindOneLiturgyQuery,
  FindOneLiturgyQueryVariables
>;
 ...
 * });
 */
export function useFindOnePrayerQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    FindOnePrayerQuery,
  ...
  return ApolloReactHooks.useQuery<
    FindOnePrayerQuery,
    FindOnePrayerQueryVariables
  >(FindOnePrayerDocument, baseOptions);
}

export function useFindOnePrayerLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    FindOnePrayerQuery,
    FindOnePrayerQueryVariables
  >
...
export type FindOnePrayerQueryHookResult = ReturnType<
  typeof useFindOnePrayerQuery
>;
export type FindOnePrayerLazyQueryHookResult = ReturnType<
  typeof useFindOnePrayerLazyQuery
>;
export type FindOnePrayerQueryResult = ApolloReactCommon.QueryResult<
  FindOnePrayerQuery,
  FindOnePrayerQueryVariables
>;
 ...
 * });
 */
export function useFindOneScriptureQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    FindOneScriptureQuery,
    FindOneScriptureQueryVariables
  >
) {
  return ApolloReactHooks.useQuery<
    FindOneScriptureQuery,
    FindOneScriptureQueryVariables
  >(FindOneScriptureDocument, baseOptions);
}

export function useFindOneScriptureLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    FindOneScriptureQuery,
    FindOneScriptureQueryVariables
  >
...
export type FindOneScriptureQueryHookResult = ReturnType<
  typeof useFindOneScriptureQuery
>;
export type FindOneScriptureLazyQueryHookResult = ReturnType<
  typeof useFindOneScriptureLazyQuery
>;
export type FindOneScriptureQueryResult = ApolloReactCommon.QueryResult<
  FindOneScriptureQuery,
  FindOneScriptureQueryVariables
>;
 ...
 * });
 */
export function useFindPrayerContentsQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    FindPrayerContentsQuery,
    FindPrayerContentsQueryVariables
  >
) {
  return ApolloReactHooks.useQuery<
    FindPrayerContentsQuery,
    FindPrayerContentsQueryVariables
  >(FindPrayerContentsDocument, baseOptions);
}

export function useFindPrayerContentsLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    FindPrayerContentsQuery,
    FindPrayerContentsQueryVariables
  >
...
export type FindPrayerContentsQueryHookResult = ReturnType<
  typeof useFindPrayerContentsQuery
>;
export type FindPrayerContentsLazyQueryHookResult = ReturnType<
  typeof useFindPrayerContentsLazyQuery
>;
export type FindPrayerContentsQueryResult = ApolloReactCommon.QueryResult<
  FindPrayerContentsQuery,
  FindPrayerContentsQueryVariables
>;
 ...
 * });
 */
export function useFindTuneQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    FindTuneQuery,
    FindTuneQueryVariables
  >
) {
  return ApolloReactHooks.useQuery<FindTuneQuery, FindTuneQueryVariables>(
    FindTuneDocument,
    baseOptions
  );
}

export function useFindTuneLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    FindTuneQuery,
    FindTuneQueryVariables
  >
) {
  return ApolloReactHooks.useLazyQuery<FindTuneQuery, FindTuneQueryVariables>(
    FindTuneDocument,
    baseOptions
  );
}
...
export type FindTuneLazyQueryHookResult = ReturnType<
  typeof useFindTuneLazyQuery
>;
export type FindTuneQueryResult = ApolloReactCommon.QueryResult<
  FindTuneQuery,
  FindTuneQueryVariables
>;
...
`;
export type ChangeFreeAccountMutationFn = ApolloReactCommon.MutationFunction<
  ChangeFreeAccountMutation,
  ChangeFreeAccountMutationVariables
>;
 ...
 * });
 */
export function useChangeFreeAccountMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    ChangeFreeAccountMutation,
    ChangeFreeAccountMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    ChangeFreeAccountMutation,
    ChangeFreeAccountMutationVariables
  >(ChangeFreeAccountDocument, baseOptions);
}

export type ChangeFreeAccountMutationHookResult = ReturnType<
  typeof useChangeFreeAccountMutation
>;
export type ChangeFreeAccountMutationResult = ApolloReactCommon.MutationResult<
  ChangeFreeAccountMutation
>;
export type ChangeFreeAccountMutationOptions = ApolloReactCommon.BaseMutationOptions<
  ChangeFreeAccountMutation,
  ChangeFreeAccountMutationVariables
>;
 ...
 * });
 */
export function useLiturgySearchQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    LiturgySearchQuery,
    LiturgySearchQueryVariables
  >
) {
  return ApolloReactHooks.useQuery<
    LiturgySearchQuery,
    LiturgySearchQueryVariables
  >(LiturgySearchDocument, baseOptions);
}

export function useLiturgySearchLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    LiturgySearchQuery,
    LiturgySearchQueryVariables
  >
...
export type LiturgySearchQueryHookResult = ReturnType<
  typeof useLiturgySearchQuery
>;
export type LiturgySearchLazyQueryHookResult = ReturnType<
  typeof useLiturgySearchLazyQuery
>;
export type LiturgySearchQueryResult = ApolloReactCommon.QueryResult<
  LiturgySearchQuery,
  LiturgySearchQueryVariables
>;
...
export function usePageContentQuery(
  ...
  return ApolloReactHooks.useQuery<PageContentQuery, PageContentQueryVariables>(
    PageContentDocument,
    baseOptions
  );
}
...
export function usePageContentLazyQuery(
  ...
  return ApolloReactHooks.useLazyQuery<
    PageContentQuery,
    PageContentQueryVariables
  >(PageContentDocument, baseOptions);
}
...
>;
export type PageContentQueryResult = ApolloReactCommon.QueryResult<
  PageContentQuery,
  PageContentQueryVariables
>;
 ...
 * });
 */
export function usePrayerSearchQuery(
  baseOptions?: ApolloReactHooks.QueryHookOptions<
    PrayerSearchQuery,
  ...
  return ApolloReactHooks.useQuery<
    PrayerSearchQuery,
    PrayerSearchQueryVariables
  >(PrayerSearchDocument, baseOptions);
}

export function usePrayerSearchLazyQuery(
  baseOptions?: ApolloReactHooks.LazyQueryHookOptions<
    PrayerSearchQuery,
    PrayerSearchQueryVariables
  >
...
export type PrayerSearchQueryHookResult = ReturnType<
  typeof usePrayerSearchQuery
>;
export type PrayerSearchLazyQueryHookResult = ReturnType<
  typeof usePrayerSearchLazyQuery
>;
export type PrayerSearchQueryResult = ApolloReactCommon.QueryResult<
  PrayerSearchQuery,
  PrayerSearchQueryVariables
>;
...
`;
export type RemoveShortListItemMutationFn = ApolloReactCommon.MutationFunction<
  RemoveShortListItemMutation,
  RemoveShortListItemMutationVariables
>;
 ...
 * });
 */
export function useRemoveShortListItemMutation(
  baseOptions?: ApolloReactHooks.MutationHookOptions<
    RemoveShortListItemMutation,
    RemoveShortListItemMutationVariables
  >
  ...
  return ApolloReactHooks.useMutation<
    RemoveShortListItemMutation,
    RemoveShortListItemMutationVariables
  >(RemoveShortListItemDocument, baseOptions);
}

export type RemoveShortListItemMutationHookResult = ReturnType<
  typeof useRemoveShortListItemMutation
>;
export type RemoveShortListItemMutationResult = ApolloReactCommon.MutationResult<
  RemoveShortListItemMutation
>;
export type RemoveShortListItemMutationOptions = ApolloReactCommon.BaseMutationOptions<
  RemoveShortListItemMutation,
  RemoveShortListItemMutationVariables
>;
...
export function useTextSearchQuery(
  ...
  return ApolloReactHooks.useQuery<TextSearchQuery, TextSearchQueryVariables>(
    TextSearchDocument,
    baseOptions
  );
}
...
export function useTextSearchLazyQuery(
  ...
  return ApolloReactHooks.useLazyQuery<
    TextSearchQuery,
    TextSearchQueryVariables
  >(TextSearchDocument, baseOptions);
}
...
>;
export type TextSearchQueryResult = ApolloReactCommon.QueryResult<
  TextSearchQuery,
  TextSearchQueryVariables
>;
