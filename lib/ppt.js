...
function produceSlide({
  ...
  pptx.layout = ratios[ratioOpt];

  pptx.defineSlideMaster({
    title: 'TITLE_SLIDE',
    background: {...bgImages[bgOpt][0]},
    objects: [
      {
        placeholder: {
          options: {
            ...
            bold: true,
            fontSize: 44,
            fontFace: fonts[fontOpt],
            color: {...bgImages[bgOpt][2]}, // 'D6FEFF',
            shadow: {
              type: 'outer',
              angle: 45,
              blur: 3,
